...
DirectoryText::DirectoryText ()
{
	...
	//Create directory list to be displayed
	HANDLE hFind;
	...
	if (hFind != INVALID_HANDLE_VALUE) {
		...
		directoryString = "Error: file directory not found.\nPlease check specified path in FindFirstFile() of DirectoryText constructor.";
	}

	/*
	system("c:/users/Big Blue/Desktop/BatComputer-OS/ /b > directory.txt");
	ifstream file("directory.txt");
	
	while (getline(file, directoryString)) {
		getline(file, directoryString);
	}
	*/
...
//==============================================================================
void DirectoryText::paint (Graphics& g)
{
...
<JUCER_COMPONENT documentType="Component" className="DirectoryText" componentName=""
  ...
  <LABEL name="new label" id="5d6499245f2045ed" memberName="label" virtualName=""
         ...
         labelText="Directory goes here!" editableSingleClick="0" editableDoubleClick="0"
